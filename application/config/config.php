...
|
*/
$config['base_url'] = 'http://localhost:8074/estacionamento/';
...
$config['sess_save_path'] = sys_get_temp_dir(); //old=NULL --> https://stackoverflow.com/questions/31042456/session-error-in-codeigniter
